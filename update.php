...
<header>
 ...
 <h2 id="h2medicos">Modificar datos de medico</h2>

     <div class="container-fluid">

      <form  action="edit_user.php" method="POST" class="formulariomedicos">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control"  name="lastname" value="<?= $row['Apellido'] ?>" >
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="speciality" value="<?= $row['Especialidad'] ?>">
  </div>
  <div class="mb-3">
    <label  class="form-label">Provincia</label>
    <input type="text" class="form-control" name="state" value="<?= $row['Provincia'] ?>" >
  </div>
  <div class="mb-3">
    <label  class="form-label">Telefono</label>
    <input type="text" class="form-control" name="phone" value="<?= $row['Telefono'] ?>">
  </div>
